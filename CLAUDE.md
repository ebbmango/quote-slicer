...
| **split**                       | Add boundary after a token index through `store.split` and `breaks.ts`; tokens remain unchanged.                                                                                                                                                                                                                                                                                                                                                                                                         |
| **merge**                       | Remove a boundary through `store.merge`; canonical whitespace remains in the stream.                                                                                                                                                                                                                                                                                                                                                                                                                     |
...
- [`docs/tokenization.md`](docs/tokenization.md) — tokenizers, source punctuation grouping, boundary extraction, whitespace strategy
- [`docs/token-store.md`](docs/token-store.md) — single token owner: canonical tokens and breaks, pinyin overlay, the line-edit animation
