# Authorship Textarea: Suppressing Browser Form Restoration
...
`autocomplete="off"` was added to the authorship textarea to prevent the browser from restoring
...
finishes initializing. This caused the authorship field to briefly display the value from the
