...
1. **[Overview](overview.md)** — what the app does, the four tools, the layout.
...
| [ADR-0003](adr/0003-layout-mode-single-source.md)    | `BreakpointContext.layoutMode` is the single macro-layout source for Svelte and CSS       |

## Companion documents (repo root)

- **[`CLAUDE.md`](../CLAUDE.md)** — dev commands, the tools table, and the canonical
